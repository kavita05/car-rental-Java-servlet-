...
import dao.OwnerDao;
@WebServlet("/EditOwnerForm")
public class EditOwnerForm extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<html>");
		out.println("<head>");
		out.println("<title>Edit Owner Form</title>");
		...
		OwnerBean bean=OwnerDao.viewById(id);
		
		out.print("<form action='EditOwner' method='post' style='width:300px'>");
